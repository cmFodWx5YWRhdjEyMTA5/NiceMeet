...
public static final int DATABASE_VERSION=1;
    ...
    public static class Country
    {
        ...
        public static final String COLUMN_NUMCODE = "num_code";
        public static final String COLUMN_ALPHA2 = "alpha_2_code";
        public static final String COLUMN_ALPHA3 = "alpha_3_code";
        public static final String COLUMN_SHORTNAME = "en_short_name";
        public static final String COLUMN_NATIONALITY= "nationality";

        public static final String[] ALL_COLUMN = {COLUMN_NUMCODE,COLUMN_ALPHA2,COLUMN_ALPHA3,COLUMN_SHORTNAME,COLUMN_NATIONALITY};
        public static final String DEFAULT_SORT = COLUMN_SHORTNAME;
        public static final String SQL_CREATE_ENTRIES =String.format("CREATE TABLE IF NOT EXISTS %s (" +
                        "  %s INTEGER PRIMARY KEY," +
                        "  %s TEXT DEFAULT NULL," +
                        "  %s TEXT DEFAULT NULL," +
                        "  %s TEXT DEFAULT NULL," +
                        "  %s TEXT DEFAULT NULL)",TABLE_NAME,COLUMN_NUMCODE,COLUMN_ALPHA2,COLUMN_ALPHA3,COLUMN_SHORTNAME,COLUMN_NATIONALITY);


        public static final String SQL_INSERT_ENTRIES = String.format("INSERT INTO %s (%s, %s, %s, %s, %s) VALUES" +
                ...
                "('716', 'ZW', 'ZWE', 'Zimbabwe', 'Zimbabwean')",TABLE_NAME,COLUMN_NUMCODE,COLUMN_ALPHA2,COLUMN_ALPHA3,COLUMN_SHORTNAME,COLUMN_NATIONALITY);
        public static final String SQL_DELETE_ENTRIES = String.format("DROP TABLE IF EXISTS %s", TABLE_NAME);
